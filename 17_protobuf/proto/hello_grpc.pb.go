...
type HelloServerClient interface {
	...
	SayHelloAgain(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Pong, error)
}
...
func (c *helloServerClient) SayHelloAgain(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Pong, error) {
	out := new(Pong)
	err := c.cc.Invoke(ctx, "/HelloServer/SayHelloAgain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloServerServer interface {
	...
	SayHelloAgain(context.Context, *emptypb.Empty) (*Pong, error)
...
func (UnimplementedHelloServerServer) SayHelloAgain(context.Context, *emptypb.Empty) (*Pong, error) {
...
func _HelloServer_SayHelloAgain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/HelloServer/SayHelloAgain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServerServer).SayHelloAgain(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
